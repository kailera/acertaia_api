-- CreateEnum
CREATE TYPE "public"."Role" AS ENUM ('USER', 'SUPERVISOR', 'TEACHER', 'COORDENATOR', 'PRINCIPAL', 'ADMIN', 'SUPERADMIN', 'SECRETARIA', 'FINANCEIRO', 'SDR', 'LOGISTICA');
...
-- CreateEnum
CREATE TYPE "public"."AgentType" AS ENUM ('SECRETARIA', 'FINANCEIRO', 'SDR', 'LOGISTICA');
